...
const sectionChangeContent = new SectionAnimation(),
    ...
    scrollMarkerProject_0 = document.getElementById('scrollMarkerProjectSample_0'),
    scrollMarkerProject_1 = document.getElementById('scrollMarkerProjectSample_1'),
    scrollMarkerProject_2 = document.getElementById('scrollMarkerProjectSample_2'),
    scrollMarkerProject_3 = document.getElementById('scrollMarkerProjectSample_3'),
    scrollMarkerProject_4 = document.getElementById('scrollMarkerProjectSample_4'),
    scrollMarkerProject_5 = document.getElementById('scrollMarkerProjectSample_5'),
    scrollMarkerProject_6 = document.getElementById('scrollMarkerProjectSample_6'),
    scrollMarkerProject_7 = document.getElementById('scrollMarkerProjectSample_7'),
    scrollMarkerProject_8 = document.getElementById('scrollMarkerProjectSample_8'),
    scrollMarkerProject_9 = document.getElementById('scrollMarkerProjectSample_9'),
    scrollMarkerProject_10 = document.getElementById('scrollMarkerProjectSample_10'),
    scrollMarkerProject_11 = document.getElementById('scrollMarkerProjectSample_11'),
    scrollMarkerProject_12 = document.getElementById('scrollMarkerProjectSample_12'),
